          ...
          return (
            <div className="flex space-x-2">
              <button
                ...
                title="Edit Record"
              >
                <img src="/icons/pen-to-square-sharp-regular-full.svg" alt="Edit" className="w-4 h-3.5" />
              </button>
              {primaryKeyField && (
                <fetcherRef.Form method="post" className="inline">
                  ...
                  >
                    <img src="/icons/trash-sharp-regular-full.svg" alt="Delete" className="w-4 h-3.5" />
                  </button>
                </fetcherRef.Form>
              )}
            </div>
          ...
          <div className="border-y border-r pt-3 col-span-3">
            <div className="flex justify-between px-5 gap-2">
              ...
              <div className="flex gap-4">
                ...
                >
                  <img src="/icons/plus-sharp-regular-full.svg" alt="Add" className="w-4 h-3.5" />
                  Add Record
                </button>
            ...
            <div className="flex items-end gap-10 pt-6 px-5">
              <div className="self-stretch p-1.5 inline-flex justify-start items-center gap-3 border-b w-full">
                <div className="flex gap-3">
                  <img src="/icons/magnifying-glass-sharp-regular-full.svg" alt="Search" className="w-4 h-4 text-zinc-400" />
                  <input
              ...
              <div className="h-10 inline-flex justify-start items-center gap-3 overflow-hidden w-full bg-[#F7F7F8] font-inter">
                ...
                <div className="flex ">
                  {table.getCanPreviousPage() && (
                    <div className="self-stretch px-4 flex justify-start items-center gap-3" onClick={() => {
                      table.previousPage();
                      const newParams = new URLSearchParams(searchParams);
                      newParams.set(
                        "offset",
                     ...
                     <img src="/icons/angle-left-sharp-regular-full.svg" alt="Previous" className="w-3 h-3 text-zinc-800" />
                    </div>
                  )}
                  ...
                  {table.getCanNextPage() && (
                    ...
                    >
                      <img src="/icons/angle-right-sharp-regular-full.svg" alt="Next" className="w-3 h-3 text-zinc-800" />
                    </div>
                  )}
                </div>
              </div>
